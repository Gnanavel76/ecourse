...
import { Form, Button, FloatingLabel, Row, Col, OverlayTrigger, Tooltip } from 'react-bootstrap'
...
const NewCourse = () => {
    ...
    return (
        <Layout>
            ...
            <h4 className="mb-4-5">New course</h4>
                        ...
                        <Row>
                            <Col md={6}>
                                <FloatingLabel controlId="price" label="Price" className="mb-4-5">
                                    <Form.Control type="number" name="price" onWheel={(e) => e.target.blur()} placeholder="Price" value={values.price} onChange={handleChange} onBlur={handleBlur} className={`${touched.price && errors.price ? 'field-error' : ''}`} />
                            ...
                            <Col md={6}>
                                <FloatingLabel controlId="discount" label="Discount" className="mb-4-5">
                                    <Form.Control type="number" onWheel={(e) => e.target.blur()} placeholder="Discount" name="discount" value={values.discount} onChange={handleChange} onBlur={handleBlur} className={`${touched.discount && errors.discount ? 'field-error' : ''}`} />
                            ...
                            <FieldArray name="courseStructure"
                                render={arrayHelpers => {
                                    ...
                                    return <>
                                        ...
                                        <button type="button" onClick={() => arrayHelpers.push('')} className="fw-bold btn py-0 px-1 text-success minw-auto mb-4">Add more Chapter</button>
                                    </>
                                }}
                            />
                        </div>
